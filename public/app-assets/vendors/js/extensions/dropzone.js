                ...
                (d = "undefined" != typeof Emitter && null !== Emitter ? Emitter : a("component~emitter@1.1.2")),
                    ...
                    (b = (function (a) {
                        function b(a, d) {
                            ...
                            if (
                                ...
                                (this.options = c({}, this.defaultOptions, e, null != d ? d : {})),
                        ...
                        return (
                            ...
                            (b.prototype.defaultOptions = {
                                ...
                                fallback: function () {
                                    ...
                                    return (
                                        c || ((c = b.createElement('<div class="dz-message"><span></span></div>')), this.element.appendChild(c)),
                                ...
                                thumbnail: function (a, b) {
                                    ...
                                    if (a.previewElement) {
                                        for (
                                            a.previewElement.classList.remove("dz-file-preview"), a.previewElement.classList.add("dz-image-preview"), f = a.previewElement.querySelectorAll("[data-dz-thumbnail]"), g = [], d = 0, e = f.length;
                                            e > d;
                                            d++
                                        )
                                ...
                                error: function (a, b) {
                                    ...
                                    if (a.previewElement) {
                                        for (
                                            a.previewElement.classList.add("dz-error"), "String" != typeof b && b.error && (b = b.error), f = a.previewElement.querySelectorAll("[data-dz-errormessage]"), g = [], d = 0, e = f.length;
                                            e > d;
                                            d++
                                        )
                            ...
                            (b.prototype.init = function () {
                                ...
                                return (
                                    ...
                                    this.on(
                                        ...
                                        (function (a) {
                                            return function () {
                                                return 0 === a.getUploadingFiles().length && 0 === a.getQueuedFiles().length
                                                    ? setTimeout(function () {
                                ...
                                return (a = this.getExistingFallback())
                                    ...
                                    : ((d = '<div class="dz-fallback">'),
                                      ...
                                      "FORM" !== this.element.tagName
                                          ? ((e = b.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')), e.appendChild(c))
                            ...
                            (b.prototype.drop = function (a) {
                                var b, c;
                                a.dataTransfer &&
                                    (this.emit("drop", a), (b = a.dataTransfer.files), b.length && ((c = a.dataTransfer.items), c && c.length && null != c[0].webkitGetAsEntry ? this._addFilesFromItems(c) : this.handleFiles(b)));
                            }),
                                ...
                                t.open(this.options.method, this.options.url, !0),
                                    ...
                                    (r = (function (b) {
                                        return function (c) {
                                            ...
                                            if (null != c) for (f = (100 * c.loaded) / c.total, g = 0, j = a.length; j > g; g++) (d = a[g]), (d.upload = { progress: f, total: c.total, bytesSent: c.loaded });
                                            else {
                                    ...
                                    (p.onprogress = r),
                                    (i = { Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest" }),
                    ...
                    (b.isBrowserSupported = function () {
                        ...
                        if (((a = !0), window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector))
                            if ("classList" in document.createElement("a")) for (f = b.blacklistedBrowsers, d = 0, e = f.length; e > d; d++) (c = f[d]), c.test(navigator.userAgent) && (a = !1);
                            else a = !1;
                        else a = !1;
                        return a;
                    }),
                    ...
                    (g = function (a) {
                        ...
                        for (
                            h = a.naturalWidth, g = a.naturalHeight, c = document.createElement("canvas"), c.width = 1, c.height = g, d = c.getContext("2d"), d.drawImage(a, 0, 0), e = d.getImageData(0, 0, 1, g).data, k = 0, f = g, i = g;
                            i > k;
