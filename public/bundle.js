      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account Register successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/jquery/dist/jquery.js":[function(require,module,exports) {
var global = arguments[3];
var process = require("process");
var define;
/*!
...
},{"process":"../../node_modules/process/browser.js"}],"shop.js":[function(require,module,exports) {
"use strict";
...
var ProductListContainer = (0, _jquery.default)('.product-list');
var filterCategory = (0, _jquery.default)('.filter-catagories'); //Sorting Array
...
window.sortingProduct = function () {
  var categoryName = '';
  var Prod = [];
  var sort = (0, _jquery.default)('.current').text();
  var minAmt = (0, _jquery.default)('#minamount').val();
  var maxAmt = (0, _jquery.default)('#maxamount').val();
  ...
  if ((0, _jquery.default)('.product-list').attr('catId') && minAmt && maxAmt && sort) {
    for (var i = 0; i < window.Products.data.data.length; i++) {
      if ((0, _jquery.default)('.product-list').attr('catId') === 'All') {
  ...
  if (window.Products) {
    if (window.Products.status === 'success') {
      ...
      for (var i = 0; i < Prod.length; i++) {
        ...
        if (window.WishList) {
          var wishList = window.WishList.items;

          _jquery.default.each(wishList, function (key, value) {
            if (Prod[i].id === key) {
              wishActive = 1;
            }
          });
        ...
        html += "\n                            <div class=\"col-lg-4 col-sm-6 blogBox moreBox\">\n                                <div class=\"product-item\">\n                                    <div class=\"pi-pic\">\n                                        <img src=\"img/products/".concat(Prod[i].imageCover, "\" alt=\"").concat(Prod[i].imageCover, "\">\n                                        ").concat(Prod[i].onsale ? '<div class="sale pp-sale">Sale</div>' : '', "\n                                        <div class=\"icon\" id=\"iconCont").concat(Prod[i].id, "\" prodID=\"").concat(Prod[i].id, "\">\n                                            ").concat(wishActive ? '<i id="delWish' + Prod[i].id + '" class="icon_heart_alt active_heart"></i>' : '<a hreft="javascript:void(0)" id="addToWishList' + Prod[i].id + '"><i class="icon_heart_alt deactive_heart"></i></a>', "\n                                        </div>\n                                        <ul prodID=\"").concat(Prod[i].id, "\">\n                                            <li id=\"addToCart").concat(Prod[i].id, "\" class=\"w-icon active\"><a href=\"javascript:void(0)\"><i class=\"icon_bag_alt\"></i></a></li>\n                                            <li class=\"quick-view\"><a href=\"/shop/").concat(Prod[i].slug, "\">+ Quick View</a></li>\n                                            <li class=\"w-icon\"><a href=\"#\"><i class=\"fa fa-random\"></i></a></li>\n                                        </ul>\n                                    </div>\n                                    <div class=\"pi-text\">\n                                        <div class=\"catagory-name\">").concat(categoryName, "</div>\n                                        <a href=\"#\">\n                                            <h5>").concat(Prod[i].name, "</h5>\n                                        </a>\n                                        <div class=\"product-price\">\n                                            $").concat(Prod[i].price, "\n                                            <span>$").concat(Prod[i].mrp, "</span>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                        ");
      }
...
function getCategoryname(id) {
  if (window.Categories.data.status = 'success') {
    for (var i = 0; i < window.Categories.data.data.length; i++) {
...
if (filterCategory) {
  (0, _jquery.default)(document).ready(function () {
    if (window.Categories) {
      var categories = window.Categories.data.data;
      var html = "<li class=\"AllFilter\" catid=\"AllFilter\" style=\"cursor: pointer;\">All Categories</li>";

      for (var i = 0; i < categories.length; i++) {
        html += "<li class=\"cat".concat(categories[i]._id, "\" cat_id=\"").concat(categories[i]._id, "\" style=\"cursor: pointer;\">").concat(categories[i].name, "</li>");
      }

      filterCategory.html(html);

      var _loop = function _loop() {
        var cat_id = (0, _jquery.default)(".cat".concat(categories[i]._id)).attr('cat_id');
        (0, _jquery.default)("li.cat".concat(cat_id)).click(function () {
          (0, _jquery.default)('.product-list').attr('catId', cat_id);
          sortingProduct();
        });
      };
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","jquery":"../../node_modules/jquery/dist/jquery.js"}],"wishList.js":[function(require,module,exports) {
"use strict";
...
var wishListConatiner = $('.product-wishlist'); //init Add/Remove WishList

$(document).ready(function () {
  if (window.Products) {
    for (var i = 1; i <= window.Products.data.data.length; i++) {
      if (window.WishList) {
        for (var r = 0; r < window.WishList.items.length; r++) {
...
function updateWishListProduct() {
  $('.heart-icon span').text(window.WishList.totalQty); //This Add First Then Delete Of we need Delte
} //Add Data to cart
...
function addToWishList(id) {
  if (id) {
    ...
    var wishList = new WishList(window.WishList ? window.WishList : {});
    var product = {};
    ...
    window.WishList = wishList; //Update WieshList Product

    updateWishListProduct(); //Send Data to server
...
function removeFromWishList(id) {
  if (id) {
    var details = window.WishList.popItem(id); //Update Cart Product

    updateWishListProduct(window.WishList.items); //Send Data to server
...
$(document).ready(function () {
  if (window.Products) {
    var _loop = function _loop(i) {
      $("#iconCont".concat(window.Products.data.data[i].id)).click(function () {
        if (window['ADD' + 1] === 1) {
          addToWishList(window.Products.data.data[i].id);
          $("#iconCont".concat(window.Products.data.data[i].id)).html("\n                            <i class=\"icon_heart_alt active_heart\"></i>\n                        ");
          window['ADD' + 1] = 0;
        } else {
...
if (window.WishList) {
  ...
  $.each(wishList, function (key, value) {
    var categoryName = getWishCategoryname(wishList[key].category_id);
    html += "\n            <div class=\"col-lg-4 col-sm-6 blogBox moreBox\">\n                <div class=\"product-item\">\n                    <div class=\"pi-pic\">\n                        <img src=\"img/products/".concat(wishList[key].imageCover, "\" alt=\"").concat(wishList[key].imageCover, "\">\n                        ").concat(wishList[key].onsale ? '<div class="sale pp-sale">Sale</div>' : '', "\n                        <div class=\"icon\" id=\"iconCont").concat(wishList[key].id, "\" prodID=\"").concat(wishList[key].id, "\">\n                            <i id=\"delWish").concat(wishList[key].id, "\" class=\"icon_heart_alt active_heart\"></i>\n                        </div>\n                        <ul>\n                            <li class=\"w-icon active\"><a href=\"/add-to-cart/").concat(wishList[key].id, "/wishList\"><i class=\"icon_bag_alt\"></i></a></li>\n                            <li class=\"quick-view\"><a href=\"/shop/").concat(wishList[key].slug, "\">+ Quick View</a></li>\n                            <li class=\"w-icon\"><a href=\"#\"><i class=\"fa fa-random\"></i></a></li>\n                        </ul>\n                    </div>\n                    <div class=\"pi-text\">\n                        <div class=\"catagory-name\">").concat(categoryName, "</div>\n                        <a href=\"#\">\n                            <h5>").concat(wishList[key].name, "</h5>\n                        </a>\n                        <div class=\"product-price\">\n                            $").concat(wishList[key].price, "\n                            <span>$").concat(wishList[key].mrp, "</span>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        ");
  });
...
},{"axios":"../../node_modules/axios/index.js","./shop":"shop.js"}],"cart.js":[function(require,module,exports) {
var axios = require('axios');
...
function Cart(oldCart) {
  ...
  this.add = function (item, id) {
    ...
    for (var _id in this.items) {
      totalQtys += this.items[_id].qty;
      totalPrices += this.items[_id].totalPrice;
    }
  ...
  this.updateQty = function (pid, pqty) {
    ...
    var qty = this.items[pid].qty;
    var productTotalPrice = this.items[pid].totalPrice;
    var price = this.items[pid].price;
    var totalQtys = 0;
    var totalPrices = 0;
...
console.log(data); // Assion Cart to Window Object
...
function updateCartProduct(product) {
  ...
  $.each(product, function (key, value) {
    html += "<tr id=\"cartPContainer".concat(product[key].id, "\">\n                    <td class=\"si-pic\" style=\"width: 30%;\">\n                        <img src=\"img/products/").concat(product[key].imageCover, "\" alt=\"\" style=\"max-width: 50%;\">\n                    </td>\n                    <td class=\"si-text\">\n                        <div class=\"product-selected\">\n                            <p id=\"DrawerCartQtyPrice").concat(product[key].id, "\">\n                                $").concat(parseFloat(product[key].price).toFixed(2), " x ").concat(product[key].qty, "\n                            </p>\n                            <h6 style=\"font-size: 10px;\">\n                                ").concat(product[key].name, "\n                            </h6>\n                        </div>\n                    </td>\n                    <td class=\"si-close\" prodid=\"").concat(product[key].id, "\">\n                        <i class=\"ti-close\" id=\"cartPClose").concat(product[key].id, "\"></i>\n                    </td>\n                </tr>");
  });
  ...
  if (window.Cart.totalQty === 0) {
    ...
    $('.cart-hover').html("\n            <div class=\"select-items\">\n                <table>\n                    <tbody id=\"cartTableBody\">\n                        ".concat(html, "\n                    </tbody>\n                </table>\n            </div>\n            <div class=\"select-total\">\n                <span>total:</span>\n                <h5 id=\"InsideCartPrice\">").concat(parseFloat(window.Cart.totalPrice).toFixed(2), "</h5>\n            </div>\n            <div class=\"select-button\">\n                <a class=\"primary-btn view-card\" href=\"/cart\">VIEW CARD</a>\n                <a class=\"primary-btn checkout-btn\" href=\"/checkout\">CHECK OUT</a>\n            </div>\n        "));
  } //Car Page 


  $("#GrandTotal").text("$".concat(parseFloat(window.Cart.totalPrice).toFixed(2))); //Cart Drawer

  $('#InsideCartPrice').text("$".concat(parseFloat(window.Cart.totalPrice).toFixed(2)));
  $('#CartPrice').text("$".concat(parseFloat(window.Cart.totalPrice).toFixed(2)));
  $('#CartQty').text("".concat(window.Cart.totalQty));
  deleteCart(product);
}
  ...
  setTimeout(function () {
    $.each(product, function (key, value) {
      ...
      function textInit(ids) {
        var prodContainer = $("#prodContainer".concat(ids));
        var cartPContainer = $("#cartPContainer".concat(ids));
        $("#closeProd".concat(ids)).click(function (el) {
          prodContainer.hide();
          cartPContainer.hide();
          removeFromCart(ids);
        });
        $("#cartPClose".concat(ids)).click(function (el) {
          prodContainer.hide();
          cartPContainer.hide();
          removeFromCart(ids);
        });
      ...
      var productId = $("#closeProd".concat(product[key].id)).parent().attr('prodID');
      var cartProductId = $("#cartPClose".concat(product[key].id)).parent().attr('prodID');
...
function addTocart(id) {
  console.log('sdfhshd'); //Get id
  // Create Cart Send to Server

  var cart = new Cart(window.Cart ? window.Cart : {}); //get Product By id
  ...
  window.Cart = cart; //Update Cart Product

  updateCartProduct(window.Cart.items); //Send Data to server
...
function removeFromCart(id) {
  var details = window.Cart.popItem(id);
  var product = {};

  for (var i = 0; i < window.Cart.items.length; i++) {
...
function UpdateCart(id, newQty) {
  if (window.Cart) {
    var cartDetails = window.Cart.updateQty(id, newQty);
    console.log(cartDetails); //Car Page 

    $("#totalPrice".concat(cartDetails.pid)).text("$".concat(parseFloat(cartDetails.productTotalPrice).toFixed(2)));
    $("#GrandTotal").text("$".concat(parseFloat(cartDetails.totalPrice).toFixed(2))); //Cart Drawer

    $("#DrawerCartQtyPrice".concat(cartDetails.pid)).text("$".concat(parseFloat(cartDetails.price).toFixed(2), " x ").concat(cartDetails.qty));
    $('#InsideCartPrice').text("$".concat(parseFloat(cartDetails.totalPrice).toFixed(2)));
    $('#CartPrice').text("$".concat(parseFloat(cartDetails.totalPrice).toFixed(2)));
    $('#CartQty').text("".concat(cartDetails.totalQty));
  }
} //Add to Cart
  ...
  if (window.Cart.items) {
    for (product in window.Cart.items) {
      /*-------------------
          Quantity change
      --------------------- */
      var proQty = $("#qty".concat(window.Cart.items[product].id));
      proQty.prepend("<span class=\"dec dec".concat(window.Cart.items[product].id, " qtybtn\">-</span>"));
      proQty.append("<span class=\"inc inc".concat(window.Cart.items[product].id, " qtybtn\">+</span>"));
      proQty.on('click', '.qtybtn', function () {
        ...
        $button.parent().find('input').val(newVal); //Update Cart Details

        UpdateCart(prodId, newVal); //Send Cart to Server
  ...
  if (data.session.hasOwnProperty('cart')) {
    ...
    if (window.Cart.items) {
      for (product in window.Cart.items) {
        ...
        var productId = $("#closeProd".concat(product)).parent().attr('prodID');
        var cartProductId = $("#cartPClose".concat(product)).parent().attr('prodID');
...
},{}],"shopConfig.js":[function(require,module,exports) {
var NavMenus = $('.nav-menu-link');
var CategoriesMenus = $('.depart-hover');
$(document).ready(function () {
  if (CategoriesMenus) {
    var html = '';
    ...
    if (window.Categories) {
      ...
      for (var i = 0; i < window.Categories.data.data.length; i++) {
        if (window.Categories.data.data[i].name === window.Url) {
          html += "\n                        <li class=\"active\">\n                            <a href=\"/shop/".concat(window.Categories.data.data[i].slug, "\">").concat(window.Categories.data.data[i].slug, "</a>\n                        </li>");
        } else {
          html += "\n                        <li>\n                            <a href=\"/shop/".concat(window.Categories.data.data[i].slug, "\">").concat(window.Categories.data.data[i].slug, "</a>\n                        </li>");
        }
      }
  ...
  if (NavMenus) {
    var NavMenuItems = ['home', 'shop', 'blog', 'contact', 'faq', 'wishList'];
    var _html = '';

    if (window.Categories) {
      console.log('hiii');

      for (var _i = 0; _i < NavMenuItems.length; _i++) {
        if (NavMenuItems[_i] === window.Url) {
          if (NavMenuItems[_i] === 'home') {
            _html += "\n                        <li class=\"active\">\n                            <a href=\"/\">".concat(NavMenuItems[_i], "</a>\n                        </li>");
          } else {
            _html += "\n                        <li class=\"active\">\n                            <a href=\"/".concat(NavMenuItems[_i], "\">").concat(NavMenuItems[_i], "</a>\n                        </li>");
          }
        } else {
          if (NavMenuItems[_i] === 'home') {
            _html += "\n                        <li>\n                            <a href=\"/\">".concat(NavMenuItems[_i], "</a>\n                        </li>");
...
var productFilterUrl = ''; // get url last
...
if (registerForm) registerForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('con-password').value;
